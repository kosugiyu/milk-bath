  ...
  */
  ...
  $(window).scroll(function(){
    ...
    $('.navlink').each(function(i){
      if($(window).scrollTop() >= $('.navlink').eq(i).offset().top -200 && $(window).scrollTop() <= $('.navlink').eq(i).offset().top+$('.navlink').eq(i).outerHeight()-200){
    ...
    if ($(this).scrollTop() >= firstScroll) {
      ...
      $('.bg1').each(function(i){
        if($(window).scrollTop() >= $('.bg1').eq(i).offset().top-$(window).height()*1){
          ...
          $(this).css({'transform':'translateY('+($(this).offset().top-$(window).scrollTop())/3+'px)'});
       }
      });
      $('.bg2').each(function(i){
        if($(window).scrollTop() >= $('.bg2').eq(i).offset().top-$(window).height()*1){

          $(this).css({'transform':'translateY('+($(this).offset().top-$(window).scrollTop())/2+'px) rotate(60deg)'});
       }
      });
      $('.bg3').each(function(i){
        if($(window).scrollTop() >= $('.bg3').eq(i).offset().top-$(window).height()*1){

          $(this).css({'transform':'translateY('+($(this).offset().top-$(window).scrollTop())/2+'px) rotate(120deg)'});
       }
      });
      $('.bg4').each(function(i){
        if($(window).scrollTop() >= $('.bg3').eq(i).offset().top-$(window).height()*1){

          $(this).css({'transform':'translateY('+($(this).offset().top-$(window).scrollTop())/6+'px)'});
       }
      });

      $('.topContact__Area--fukidashi').each(function(i){
        if($(window).scrollTop() >= $('.topContact__Area--fukidashi').eq(i).offset().top-$(window).height()*1){
